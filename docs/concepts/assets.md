...
Assets are the fundamental building blocks of energy systems in odys. They represent energy generation, storage, and consumption components that can be optimized to meet system demands at minimum cost.
