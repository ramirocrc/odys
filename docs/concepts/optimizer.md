...
The optimization engine in odys transforms energy system models into mathematical optimization problems and solves them using state-of-the-art solvers.
