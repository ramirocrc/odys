...
def test_detailed_results_format(energy_system_sample: EnergySystem) -> None:
    ...
    expected_index = pd.MultiIndex.from_tuples(
        [
            ("battery_1", "battery_charge", "0"),
            ("battery_1", "battery_charge", "1"),
            ("battery_1", "battery_charge", "2"),
            ("battery_1", "battery_charge", "3"),
            ("battery_1", "battery_charge", "4"),
            ...
            ("battery_1", "battery_discharge", "0"),
            ("battery_1", "battery_discharge", "1"),
            ("battery_1", "battery_discharge", "2"),
            ("battery_1", "battery_discharge", "3"),
            ("battery_1", "battery_discharge", "4"),
